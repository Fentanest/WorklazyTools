...
const generatedClassAllowlist = Object.freeze([
  ...
  { className: "ui-accent-blue", owner: "ToolCard", purpose: "ui-accent-${accent}" },
  { className: "ui-accent-green", owner: "ToolCard", purpose: "ui-accent-${accent}" },
  { className: "ui-accent-orange", owner: "ToolCard", purpose: "ui-accent-${accent}" },
  { className: "ui-accent-pink", owner: "ToolCard", purpose: "ui-accent-${accent}" },
  { className: "ui-accent-sky", owner: "ToolCard", purpose: "ui-accent-${accent}" },
  { className: "ui-accent-violet", owner: "ToolCard", purpose: "ui-accent-${accent}" },
