...
const pages = [
  ...
  },
  {
    ...
    sections: [["안전한 이용", "처리할 권한이 있는 파일만 사용하고 중요한 원본은 별도로 보관해야 합니다."], ["결과 확인", "브라우저에서 만든 문서·미디어 결과와 텍스트·QR·표 변환 결과를 실제 사용 전에 직접 확인하세요."], ["계산기 결과", "영업일·연차·급여·퇴직금은 표시된 기준과 입력값에 따른 참고 결과이며 회사 규정, 근태, 비과세 급여와 실제 신고 기준에 따라 달라질 수 있습니다."], ["보안 도구", "비밀번호 강도와 예상 해독 시간은 초당 100억 회 대입을 가정한 비교값이며 QR 스캔 결과의 URL 안전성을 보증하지 않습니다."], ["서비스 변경", "브라우저와 서비스 제공 환경의 변경에 따라 기능이 수정되거나 일시 중단될 수 있습니다."]],
  },
  {
    route: "contact",
