...
const tools = [
  ...
  tool("document-generator", "#0879d9", "문서 자동 작성", "DOCX 문서 일괄 생성", "DOCX 양식 · Excel·CSV · 행별 문서", "Document automation", "Bulk DOCX Generator", "DOCX template · Excel & CSV · row documents"),
  ...
  tool("pdf-compare", "#7554d8", "PDF 비교", "PDF 파일 비교", "페이지 화면 · 추출 텍스트 · 쌍별 보고서", "PDF comparison", "PDF Compare", "Rendered pages · extracted text · reports"),
  ...
  tool("pdf-editor-merge", "#7554d8", "PDF 편집·변환", "PDF 합치기", "여러 PDF · 순서대로 · 하나로 합치기", "PDF editing & conversion", "Merge PDFs", "Multiple PDFs · in order · one file"),
  ...
  tool("video-studio-trim", "#d8468f", "미디어", "비디오 자르기", "구간 선택 · MP4 저장", "Media", "Trim Video", "Section · MP4"),
  tool("video-studio-merge", "#d8468f", "미디어", "비디오 합치기", "여러 영상 · 하나로 합치기", "Media", "Join Videos", "Multiple videos · one MP4"),
  tool("video-studio-extract-audio", "#d8468f", "미디어", "비디오 음원 추출", "소리만 · MP3 저장", "Media", "Extract Audio from Video", "Sound only · MP3"),
  tool("audio-studio-trim", "#7554d8", "미디어", "오디오 자르기", "구간 선택 · 저장", "Media", "Trim Audio", "Section · save"),
