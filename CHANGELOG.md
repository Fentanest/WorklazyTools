...
- PDF 마무리에 번호·머리말·워터마크·도장의 복합 실행 순서와 다중 PDF 순차 처리, 개별 결과·안전한 ZIP 다운로드, 부분 결과 보존을 추가했다. legacy organize preset과 실제 두 옵션 호환 스모크, 8개 복합 PDF 골든·mutant, 27항 누락 감사를 고정하고 모든 finish preset의 canonical을 `/finish`로 통일했다. — Codx
