...
- DART 본문검색으로 국민연금 언급을 2006년부터 지속 조사하고, 2000~2005년 이전 범위와 2006~2008년 직접 D001 목록을 각각 독립 커서로 재개하도록 했다. 완료한 검색창의 페이지·검색어별 건수·digest와 원문 검토 후보를 별도 원장에 기록하고, 원문 근접 문맥만 확인해 보유·평가로 자동 승격하지 않는다. 화면에는 검색 진척과 원문 확인된 과거·계획 표본 9건을 직접 제출 공시와 분리해 표시했다. — Codx
