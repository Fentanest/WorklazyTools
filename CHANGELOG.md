...
- 검수에서 찾은 정정 공시 상태·과거 이벤트 누락·상장 종목 재시도·가격 기준일 역전·과거 주식 변동 검사를 보강했다. 종가는 네이버 15:30 분봉에서 읽어 같은 날 KRX 공식 표본과 대조했고, 기존 일별 가격 캐시를 새 방법론에서 제외했다. 화면 FAQ를 정적 가이드 원문과 통일하고 게시 시각이 기록되지 않은 경우를 명확히 표시했다. — Codx / Muse
