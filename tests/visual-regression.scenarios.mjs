  ...
  "image-studio": Object.freeze([
    Object.freeze({
      ...
      actions: [
        ...
        { type: "scroll-into-view", selector: "[data-testid='image-editor-toolbar']", offset: -72 },
      ],
    ...
    Object.freeze({
      ...
      actions: [
        ...
        { type: "scroll-into-view", selector: "[data-testid='image-editor-options-panel']", offset: -72 },
      ],
      assertSelector: "[data-testid='image-editor-options-panel'][data-panel='size']",
    }),
    Object.freeze({
      stateId: "interaction-layers-panel",
      fixture: {
        kind: "generated-png",
        fileName: `visual-layer-panel-${"extremely-long-original-file-name-for-ellipsis-verification-".repeat(6)}.png`,
        width: 900,
        height: 160,
      },
      actions: [
        { type: "upload", selector: "[data-tool-page='image-studio'] input[type='file']" },
        { type: "wait-canvas", selector: "[data-testid='image-editor-canvas-stage'] .lower-canvas" },
        { type: "assert-truncated", selector: ".editor-source-actions > span" },
        { type: "click", selector: "[data-testid='image-editor-panel-text']" },
        { type: "replace-text", selector: "[data-testid='image-editor-text-input']", value: "Layer name long enough to require visible ellipsis in the layers panel" },
        { type: "click", selector: "[data-testid='image-editor-add-text']" },
        { type: "click", selector: "[data-testid='image-editor-panel-shapes']" },
        { type: "wait", selector: "[data-testid='image-editor-options-panel'][data-panel='shapes']" },
        { type: "click", selector: "[data-testid='image-editor-shape-star']" },
        { type: "click", selector: "[data-testid='image-editor-shape-star']" },
        { type: "click", selector: "[data-testid='image-editor-shape-star']" },
        { type: "click", selector: "[data-testid='image-editor-shape-star']" },
        { type: "click", selector: "[data-testid='image-editor-shape-star']" },
        ...
        { type: "click", selector: "[data-testid='image-editor-shape-star']" },
        { type: "click", selector: "[data-testid='image-editor-shape-star']" },
        { type: "click", selector: "[data-testid='image-editor-panel-layers']" },
        { type: "wait", selector: "[data-testid='image-editor-options-panel'][data-panel='layers'] .image-editor-layer-row:nth-child(11)" },
        { type: "assert-truncated", selector: ".image-editor-layer-row[data-layer-kind='text'] .image-editor-layer-select > span:last-child" },
        { type: "assert-scroll-overflow", selector: ".image-editor-layer-list", axis: "y" },
        { type: "scroll-into-view", selector: ".editor-source-actions", offset: -72 },
      ],
      assertSelector: "[data-testid='image-editor-options-panel'][data-panel='layers']",
    }),
    Object.freeze({
