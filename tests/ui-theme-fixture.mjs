...
// (light-coral/dark-coral); the mint family is future work, not silently
// mapped. The seed stores ONLY worklazy-theme: locale and consent stay under
...
export function themeForProfile(profileTheme) {
  const theme = THEME_FAMILY_DEFAULT[profileTheme];
