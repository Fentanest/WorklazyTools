...
def update_tools_json():
    ...
    with open("src/locales/ko/tools.json", "r", encoding="utf-8") as f:
        tools = json.load(f)

    # We map tool path to toolId
    path_to_id = {
        "excel-merger": "excel-merger",
        ...
        "document-redactor": "document-redactor",
        "image-privacy": "image-privacy",
    ...
    with open("src/locales/ko/tools.json", "w", encoding="utf-8") as f:
        json.dump(tools, f, ensure_ascii=False, indent=2)
    print("Updated ko/tools.json")
