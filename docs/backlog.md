...
- **BNK 과거 관측 운영 저장과 범위 확대**: 검증 전용 Actions `36270038754`에서 2025-12-31 보통주 관측 1건을 공식 목록·OpenDART ZIP으로 재현했다. 운영 data branch에는 아직 저장하지 않았으므로 검수 후 대상 재검사에서 영속화하고, 다른 문서 구조는 각각 검증한다. 이 공시는 현재 보유 기준일이 아니라 2025년 말 과거 관측이다. — Codx
