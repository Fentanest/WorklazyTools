...
- **후속 — 공시 정정·취소/metadata 복구**: 현재 원문 파서와 durable unresolved 큐는 있으나 정정 원접수번호 연결·취소 관계, metadata 미해결 596건의 한정 복구, 실제 시세 입력을 통한 게시 스냅샷은 완료되지 않았다. C08·B07·D01~D12·E03/E09~E11의 생산 판정은 보류한다. — Codx
