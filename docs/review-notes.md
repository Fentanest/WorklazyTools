...
- 1999–2004년 D001 사전 탐색에서는 넓은 `국민연금` 조건의 일치가 0건이었다. 2005년 broad match 20건의 첫 10건은 실제 기관이 아닌 벤처조합이었다. 목록 후보는 기관 제출인 시작·경계와 대량보유 보고서명으로 좁혔다. 실제 첫 기관 접수 연도는 엄격 조건의 진행 중 탐색 결과로만 확정한다. 원문 파싱 실패는 검증되지 않은 접수로 남기고 다음 날짜에 한정 재시도한다. — Codx
