...
- 네이버 `basic`·일별 응답의 2026-09-23 종가는 000660=1,863,000, 005930=286,500, 0126Z0=331,000이나 각각 20시 이후 최종값이다. 네이버 `fchart.stock.naver.com/sise.nhn`의 15:30 분봉은 1,862,000 / 285,500 / 330,000으로 [KRX KIND 종가](https://kind.krx.co.kr/common/stockprices.do?isurCd=00066&method=searchStockPricesMain)와 세 종목 모두 일치한다. 추가 분산 10개 종목도 10/10 일치했다. 따라서 기존 basic/일별 캐시는 평가 가격으로 재사용하지 않고, 정확한 거래일의 15:30 분봉만 정규장 종가로 채택한다. SK스퀘어는 15:30 행 없이 15:32 첫 체결값 1,190,000이 [KRX KIND 공식 종가](https://kind.krx.co.kr/common/stockprices.do?isurCd=40234&method=searchStockPricesMain)와 같았다. 이 드문 경우만 15:31–15:39 차트값 전부 동일·첫값 15:35 이내·공식 종가/종목코드/회사명/날짜 일치를 추가 확인한다. 하나라도 확인되지 않으면 평가에서 제외한다. [KRX 2026 휴장 안내](https://kind.krx.co.kr/external/dst/notice/11637/%5B%ED%95%9C%EA%B5%AD%EA%B1%B0%EB%9E%98%EC%86%8C%5D%202026%EB%85%84%20%EC%98%AC%EB%B9%BC%EB%AF%B8%EA%B3%B5%EC%8B%9C%20%EC%95%88%EB%82%B4.pdf)는 9/24~27 휴장을 확인한다. 미확인 휴장·특수 개장일에는 검증 실패로 게시를 멈추며, 과거 수정주가 계열의 의미는 추론하지 않는다. — Codx
