...
export function TextToolsPage() {
  ...
  return (
    <UtilityPage toolId="text-tools">
      ...
      <ToolGuide title={t("features:textTools.guide.title")} description={t("features:textTools.guide.description")} blocks={t("features:textTools.guide.blocks", { returnObjects: true }) as any} faq={(t("features:textTools.guide.faq", { returnObjects: true }) as any[] || []).map((item: any) => ({ question: item.q, answer: item.a }))} />
    </UtilityPage>
  );
}
