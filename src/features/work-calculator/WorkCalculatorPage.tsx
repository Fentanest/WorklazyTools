...
export function WorkCalculatorPage() {
  ...
  return <UtilityPage toolId="work-calculator">
    ...
    <ToolGuide title={t("work.guide.title")} description={t("work.guide.description")} blocks={t("work.guide.blocks", { returnObjects: true }) as any} faq={(t("work.guide.faq", { returnObjects: true }) as any[] || []).map((item: any) => ({ question: item.q, answer: item.a }))} />
  </UtilityPage>;
}
