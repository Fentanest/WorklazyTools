...
export function SecurityToolsPage() {
  ...
  return <div className="page tool-page page-enter utility-page security-page">
    <PageHeader eyebrow="SECURITY" title="비밀번호 생성·강도 측정" description="운영체제의 암호학적 난수로 비밀번호를 만들고 추측 공격에 대한 강도를 로컬에서 점검하세요." />
