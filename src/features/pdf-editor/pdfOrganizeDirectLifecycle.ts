...
export function usePdfOrganize(preset: PdfOrganizePreset | undefined, dirty: boolean, apply: (preset: PdfOrganizePreset | undefined) => void) {
  ...
  const [pendingPreset, setPendingPreset] = useState<{ preset: PdfOrganizePreset | undefined; location: DirectEntryLocation }>();
