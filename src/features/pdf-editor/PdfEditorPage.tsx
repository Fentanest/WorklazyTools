  ...
  return (
    <ToolGuide
      ...
      blocks={isConvert ? [
        ...
        {
          title: "OCR 모델과 개인정보",
          paragraphs: ["OCR을 처음 사용할 때 한국어와 영어 학습 모델 및 실행 구성요소를 외부 배포망에서 내려받습니다. 이 과정에는 인터넷 연결이 필요하며 일반적인 접속 정보가 배포망에 전달될 수 있지만, 사용자가 선택한 PDF 페이지나 인식 결과를 그곳으로 보내지는 않습니다.", "학습 모델은 브라우저 캐시 정책에 따라 저장되어 다음 실행이 빨라질 수 있습니다. 캐시 삭제, 시크릿 모드 또는 브라우저 저장 공간 부족 상황에서는 다시 내려받을 수 있습니다."],
        },
        {
          title: "대용량 문서 처리",
