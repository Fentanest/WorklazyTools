...
export function ImagePrivacyPage() {
  ...
  return <UtilityPage toolId="image-privacy">
    ...
    <ToolGuide title={t("imagePrivacy.guide.title")} description={t("imagePrivacy.guide.description")} blocks={t("imagePrivacy.guide.blocks", { returnObjects: true }) as any} faq={(t("imagePrivacy.guide.faq", { returnObjects: true }) as any[] || []).map((item: any) => ({ question: item.q, answer: item.a }))} />
  </UtilityPage>;
}
