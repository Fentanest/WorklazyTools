...
import type { ImageDirectPreset } from "./imageDirect";
export function useImageDirect(preset: ImageDirectPreset | undefined, dirty: boolean, apply: (preset: ImageDirectPreset | undefined) => void) {
  ...
  const [pendingPreset, setPendingPreset] = useState<{ preset: ImageDirectPreset | undefined; location: DirectEntryLocation }>();
