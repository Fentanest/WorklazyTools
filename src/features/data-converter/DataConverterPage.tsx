...
export function DataConverterPage() {
  ...
  return <UtilityPage toolId="data-converter">
    ...
    <ToolGuide title={t("features:converter.guide.title")} description={t("features:converter.guide.description")} blocks={t("features:converter.guide.blocks", { returnObjects: true }) as any} faq={(t("features:converter.guide.faq", { returnObjects: true }) as any[] || []).map((item: any) => ({ question: item.q, answer: item.a }))} />
  </UtilityPage>;
}
