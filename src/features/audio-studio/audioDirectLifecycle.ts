...
import type { AudioDirectPreset } from "./audioDirect";
export function useAudioDirect(preset: AudioDirectPreset | undefined, dirty: boolean, apply: (preset: AudioDirectPreset | undefined) => void) {
  ...
  const [pendingPreset, setPendingPreset] = useState<{ preset: AudioDirectPreset | undefined; location: DirectEntryLocation }>();
