  ...
  return (
    <div className="page standard-page page-enter content-page">
      ...
      <article className="prose-card">
        ...
        <p>사진의 GPS 좌표와 급여 계산에 입력한 금액은 결과를 보여주기 위한 현재 화면 상태로만 사용합니다. 오디오 편집기의 디코딩된 PCM 채널, 선택 구간과 페이지 내 오디오 클립보드도 현재 탭의 메모리에서만 사용하며, 작업별 Worker와 AudioContext는 완료·교체·종료 시 정리합니다. 비디오 스튜디오의 MP3·AAC 결과를 오디오 스튜디오에서 계속 편집할 때는 같은 출처의 새 탭으로 Blob을 한 번만 메모리 전달하고 통신 채널을 닫으며, 브라우저 저장소에 결과 파일을 보관하지 않습니다. Worklazy Tools는 해당 값을 계정, 분석 데이터 또는 광고 데이터에 연결하지 않습니다.</p>
