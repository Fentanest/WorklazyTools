    ...
    <div className="page standard-page page-enter content-page">
      ...
      <article className="prose-card">
        ...
        <ul>
          ...
          <li>비디오 인코딩은 입력 코덱, 브라우저 메모리와 기기 성능의 영향을 받습니다. MKV·AVI는 완벽한 호환을 보장하지 않으며 HEVC와 MKV 결과는 일부 기기에서 재생되지 않을 수 있습니다. 오디오 원본 유지는 첫 번째 트랙을 자동 변환 없이 복사하므로 출력 컨테이너와 호환되지 않으면 실패할 수 있습니다.</li>
          <li>오디오 편집은 브라우저가 입력 코덱을 디코딩할 수 있어야 합니다. M4A·AAC·OGG 지원은 기기마다 다를 수 있으며, 긴 다채널 파일과 Undo 기록은 브라우저 메모리를 많이 사용합니다. 중요한 결과는 별도 플레이어에서 확인해야 합니다.</li>
