  ...
  return (
    <div className="page standard-page page-enter content-page">
      ...
      <article className="prose-card">
        ...
        <h2>1. 서비스의 목적</h2>
        <p>Worklazy Tools는 Excel 파일 병합, Word 문서 비교, HWP 문서 편집, PDF 편집·변환·OCR, 비디오와 이미지 편집 등 반복적인 파일 작업을 브라우저에서 수행할 수 있도록 제공하는 무료 도구입니다. 별도 계정이나 설치 프로그램 없이 사용할 수 있습니다.</p>
